					   ...
					   struct net_device *dev)
{
	...
	/* HW checksum info, if the XDP program vouched for it */
 ...
 * program can decide whether to vouch for it (e.g. via bpf_xdp_store_rx_csum()
...
/**
 * bpf_xdp_store_rx_csum - Assert the packet's L4 checksum is correct.
 * @ctx: XDP context pointer.
 *
 ...
 * Return: 0.
 */
__bpf_kfunc int bpf_xdp_store_rx_csum(struct xdp_md *ctx)
{
...
BTF_ID_FLAGS(func, bpf_xdp_store_rx_csum)
